...
PORT=63854
UUID=c0e4545a-5430-4aff-8a21-0754054dd22f
WebPage=https://bing.com
CaddyConfig=https://raw.githubusercontent.com/apple12345abc/python/python/etc/Caddyfile
XRayConfig=https://raw.githubusercontent.com/apple12345abc/python/python/etc/xray.json
